...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString(QObject::tr("WXCOINs"));
    case mBTC: return QString(QObject::tr("Milli-WXCOINs (1 / 1,000)"));
    case uBTC: return QString(QObject::tr("Micro-WXCOINs (1 / 1,000,000)"));
    default: return QString("???");
    }
}
